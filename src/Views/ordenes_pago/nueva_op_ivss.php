<?php
session_start();
if (!isset($_SESSION['usuario'])) { header('Location: /sistema/public/login.php'); exit; }
...
<head>
<meta charset="UTF-8">
<meta name="description" content="Nueva Orden de Pago IVSS Y PF — Contraloría del Municipio Simón Rodríguez">
<title>Nueva OP IVSS Y PF — Contraloría MSR</title>
...
/* Panel helper */
.panel-ivss{border:1px solid #1565c0;background:#f5f0ff;padding:12px 16px;margin-bottom:14px;border-radius:4px;}
.panel-ivss .pb-title{font-size:11px;font-weight:bold;color:#673ab7;text-transform:uppercase;margin-bottom:10px;display:flex;align-items:center;gap:6px;}
.panel-ivss .pb-grid{display:flex;flex-wrap:wrap;gap:12px;align-items:flex-end;}
.panel-ivss label{font-size:10px;font-weight:bold;display:block;margin-bottom:3px;color:#333;}
.panel-ivss select,.panel-ivss input{border:1px solid #673ab7;padding:4px 8px;font-size:11px;font-family:'Inter',sans-serif;outline:none;background:#fff;text-transform:uppercase;}
/* Document */
.op-document{border:2px solid #000;background:#fff;font-family:'Inter',sans-serif;color:#000;width:100%;box-sizing:border-box;}
.op-header-grid{display:flex;align-items:center;justify-content:space-between;padding:8px 14px;border-bottom:1.5px solid #000;}
.op-logo-left img,.op-logo-right img{height:70px;width:auto;display:block;}
.op-header-center{text-align:center;line-height:1.3;}
...
.op-row-title{display:flex;border-bottom:1.5px solid #000;}
.op-title-cell{flex:1;display:flex;align-items:center;justify-content:center;border-right:1.5px solid #000;padding:6px;}
.op-title-cell h2{font-size:16px;font-weight:800;letter-spacing:1.5px;text-transform:uppercase;margin:0;}
.op-num-fecha-cell{width:270px;display:flex;flex-direction:column;}
.op-nf-row{display:flex;border-bottom:1px solid #000;height:24px;align-items:center;}
.op-nf-row:last-child{border-bottom:none;}
.op-nf-row label{width:85px;font-weight:bold;font-size:11px;padding-left:8px;border-right:1.5px solid #000;height:100%;display:flex;align-items:center;}
.op-nf-row input{flex:1;border:none;padding:2px 6px;font-size:12px;font-weight:bold;text-align:center;font-family:'Inter',sans-serif;outline:none;background:transparent;}
...
/* Purple Specific Headers */
.op-row-benef-lbl{display:flex;border-bottom:1px solid #000;background:#d2d7f4 !important;font-weight:bold;font-size:10px;}
...
.op-row-benef-val{display:flex;border-bottom:1px solid #000;min-height:24px;align-items:center;}
.op-cell-benef-val{flex:1;border-right:1px solid #000;padding:2px 8px;font-weight:bold;font-size:11.5px;text-transform:uppercase;}
.op-cell-nit-val{width:90px;border-right:1px solid #000;min-height:24px;}
.op-cell-rif-val{width:220px;padding:2px 8px;font-weight:bold;font-size:11.5px;}

.op-row-cant-lbl{border-bottom:1px solid #000;padding:3px 8px;font-weight:bold;font-size:10px;background:#d2d7f4 !important;}
.op-row-cant-val{border-bottom:1.5px solid #000;padding:6px 8px;font-size:11.5px;font-weight:bold;font-style:italic;min-height:30px;display:flex;align-items:center;}

.op-row-concepto-lbl{border-bottom:1px solid #000;padding:3px 8px;font-weight:bold;font-size:10px;text-transform:uppercase;background:#d2d7f4 !important;}
.op-row-concepto{border-bottom:1.5px solid #000;padding:10px 12px;min-height:60px;display:flex;align-items:center;justify-content:center;}
.op-row-concepto textarea{width:100%;border:none;outline:none;resize:none;overflow:hidden;font-family:'Inter',sans-serif;font-size:11.5px;font-weight:700;line-height:1.5;text-transform:uppercase;text-align:center;background:transparent;box-sizing:border-box;}

/* Banco */
.op-row-banco{display:flex;border-bottom:1.5px solid #000;align-items:center;min-height:32px;}
.op-cell-banco{flex:1;display:flex;align-items:center;padding:4px 8px;border-right:1px solid #000;font-size:11px;font-weight:bold;}
.op-cell-banco label{margin-right:6px;white-space:nowrap;}
.op-cell-banco select{flex:1;border:none;font-size:11px;font-weight:bold;font-family:'Inter',sans-serif;text-transform:uppercase;outline:none;background:transparent;cursor:pointer;}
.op-cell-cuenta{flex:1.2;display:flex;align-items:center;padding:4px 8px;border-right:1px solid #000;font-size:11px;font-weight:bold;}
...
.op-cell-monto{width:270px;display:flex;align-items:center;padding:4px 8px;font-size:11px;font-weight:bold;}
.op-cell-monto label{margin-right:8px;white-space:nowrap;}
.monto-bs-box{flex:1;border:2px solid #000;padding:2px 6px;background:#fff;}
.monto-bs-box input{width:100%;border:none;text-align:right;font-size:12px;font-weight:800;font-family:'Inter',sans-serif;outline:none;background:transparent;}

/* Retenciones */
.op-table-ret{width:100%;border-collapse:collapse;font-size:10px;}
.op-table-ret th{border-bottom:1.5px solid #000;border-right:1px solid #000;padding:4px 6px;font-weight:bold;text-align:left;font-size:10.5px;background:#fff;}
.op-table-ret th:last-child{border-right:none;}
.op-table-ret td{border-bottom:1px solid #000;border-right:1px solid #000;padding:3px 6px;}
.op-table-ret td:last-child{border-right:none;}
.op-table-ret input{width:100%;border:none;font-size:11px;font-family:'Inter',sans-serif;outline:none;background:transparent;}
.op-ret-totals{display:flex;justify-content:space-between;align-items:center;border-bottom:1.5px solid #000;padding:4px 8px;}
.op-ret-totals-right{display:flex;flex-direction:column;gap:4px;align-items:flex-end;margin-left:auto;}
.op-ret-tot-row{display:flex;align-items:center;gap:10px;font-size:11px;font-weight:bold;}
.op-ret-tot-row .val-box{border:1.5px solid #000;padding:2px 8px;min-width:130px;text-align:right;font-weight:bold;}
.op-ret-tot-row .val-box-bold{border:2px solid #000;padding:2px 8px;min-width:130px;text-align:right;font-weight:800;font-size:12px;}

/* Contabilidad */
.op-cont-header-bar{border-bottom:1.5px solid #000;display:flex;align-items:center;justify-content:center;padding:4px;font-weight:bold;font-size:11px;letter-spacing:0.5px;background:#d2d7f4 !important;}
.op-cont-total-box{border:2px solid #000;padding:2px 8px;min-width:110px;text-align:right;font-weight:800;font-size:12px;font-style:italic;background:#fff;color:#000;}
.op-table-cont{width:100%;border-collapse:collapse;font-size:10px;}
.op-table-cont th{border-bottom:1.5px solid #000;border-right:1px solid #000;padding:3px 2px;text-align:center;font-weight:bold;font-size:9.5px;line-height:1.1;}
.op-table-cont th:last-child{border-right:none;}
.op-table-cont td{border-bottom:1px solid #000;border-right:1px solid #000;padding:2px;text-align:center;}
.op-table-cont td:last-child{border-right:none;}
.op-table-cont input{width:100%;border:none;text-align:center;font-size:10px;font-family:'Inter',sans-serif;outline:none;background:transparent;}

/* Unified Firmas & Pagado Grid */
.op-unified-bottom-grid{display:flex;flex-direction:column;border-top:1.5px solid #000;}
.op-grid-row{display:grid;grid-template-columns:1.1fr 1.1fr 1.5fr 1.2fr;border-bottom:1px solid #000;}
.op-grid-row:last-child{border-bottom:none;}
.op-grid-row > div{border-right:1px solid #000;display:flex;align-items:center;justify-content:center;box-sizing:border-box;font-family:'Inter',sans-serif;}
.op-grid-row > div:last-child{border-right:none;}

/* Row 1: Headers (Purple) */
.op-row-hdr-purple{background:#d2d7f4 !important;font-weight:bold;font-size:9.5px;text-align:center;line-height:1.2;text-transform:uppercase;padding:5px 4px;}

/* Row 2: Signature Space */
.op-row-sig-body{min-height:48px;background:#fff;}
.op-row-sig-body > div{flex-direction:column;justify-content:flex-end;padding-bottom:3px;font-size:9px;font-weight:bold;color:#222;text-transform:uppercase;}

/* Row 3: Names (Purple) */
.op-row-names-purple{background:#d2d7f4 !important;font-weight:bold;font-size:10px;text-align:center;text-transform:uppercase;padding:4px;}

/* Row 4: Pagado Header (Purple) */
.op-row-pagado-purple{background:#d2d7f4 !important;font-weight:bold;font-size:9.5px;text-align:center;text-transform:uppercase;padding:4px;}

/* Row 5: Pagado Data Row */
.op-row-pagado-data{min-height:36px;background:#fff;}
.op-row-pagado-data > div{padding:2px 6px;font-size:11px;font-weight:bold;}
.op-row-pagado-data input, .op-row-pagado-data select{width:100%;border:none;outline:none;background:transparent;text-align:center;font-size:11px;font-weight:bold;font-family:'Inter',sans-serif;text-transform:uppercase;}
...
body{background:white !important;color:#000 !important;min-height:100vh !important;}
.no-print,.site-header,.site-footer,.sidebar,.btns,.btn-add{display:none !important;}
.layout{display:flex !important;align-items:center !important;justify-content:center !important;min-height:100vh !important;}
.main-content{padding:0 !important;margin:0 !important;overflow:visible !important;}
.container{border:none !important;padding:0 !important;margin:0 !important;width:100% !important;max-width:100% !important;box-shadow:none !important;}
.op-document{border:2px solid #000 !important;page-break-inside:avoid;zoom:0.94;margin:0 auto !important;}
input,select,textarea{border:none !important;background:transparent !important;-webkit-appearance:none !important;appearance:none !important;color:#000 !important;font-family:'Inter',sans-serif !important;}
}
</style>
</head>
<body><div class="layout">
<?php $active = 'op-ivss'; require_once __DIR__ . '/../../../includes/sidebar.php'; ?>
<main class="main-content">
<div class="container">

<!-- Panel IVSS helper -->
<div class="panel-ivss no-print">
    <div class="pb-title">&#127970; IVSS Y PF &mdash; Configurar datos del pago</div>
    <div class="pb-grid">
        <div>
            <label>MES</label>
        ...
        <div>
            ...
            <input type="number" id="arr-anio" value="<?php echo $anio_actual; ?>" min="2020" max="2099" onchange="buildConcepto()" style="width:70px;">
        </div>
        <div>
            <label>N&deg; MEMORANDUM</label>
            <input type="text" id="arr-memo-num" value="" oninput="buildConcepto()" style="width:130px;" placeholder="CM-000-2026">
        </div>
        <div>
            <label>FECHA MEMORANDUM</label>
            <div style="position: relative; width: 100px;">
                <input type="text" id="arr-memo-fecha" value="<?php echo $fecha_hoy; ?>" oninput="buildConcepto()"
        ...
        <div>
            <label>CUENTA DESTINO IVSS</label>
            <input type="text" id="arr-cuenta-ivss" value="0102-0509-31-0000072025" oninput="buildConcepto()" style="width:175px;" placeholder="0000-0000-00-0000000000">
        </div>
    </div>
</div>

<form method="POST" action="../../controllers/ordenes_pago/guardar_op_ivss.php" id="form-op">
<?php if ($op_edit): ?>
...
<div class="op-document">
    ...
    <div class="op-row-title">
        <div class="op-title-cell"><h2>ORDEN DE PAGO</h2></div>
        <div class="op-num-fecha-cell">
            <div class="op-nf-row">
                <label>NUMERO:</label>
                <input type="text" name="numero_op" id="numero_op" required placeholder="000" value="<?php echo htmlspecialchars($op_edit ? $op_edit['numero'] : ''); ?>">
            </div>
            <?php
            $val_fecha_db = ($op_edit && !empty($op_edit['fecha'])) ? $op_edit['fecha'] : date('Y-m-d');
            ...
            <div class="op-nf-row">
                ...
                <div style="position: relative; flex: 1; height: 100%; display: flex; align-items: center;">
                    <input type="hidden" name="fecha" id="fecha_op"
    ...
    <div class="op-row-benef-val" style="border-bottom:1.5px solid #000;">
        <div class="op-cell-benef-val">INSTITUTO VENEZOLANO DE LOS SEGUROS SOCIALES</div>
        <div class="op-cell-nit-val"></div>
        <div class="op-cell-rif-val">G-20004076-9</div>
    </div>
    ...
    <div class="op-row-banco">
        ...
        <div class="op-cell-cuenta">
            ...
            <input type="text" name="numero_cuenta" id="numero_cuenta" placeholder="0102-0509-31-0000072355"
                value="<?php echo htmlspecialchars($op_edit ? $op_edit['numero_cuenta'] : ''); ?>"
                oninput="fmtCuenta(this)">
        </div>
        <div class="op-cell-monto">
            <label>MONTO BS.</label>
            <div class="monto-bs-box"><input type="text" id="monto-bs" placeholder="0.00" value="<?php echo htmlspecialchars($op_edit ? number_format($op_edit['monto_neto_pagar'], 2, '.', ',') : '0.00'); ?>"></div>
        </div>
    </div>

    <!-- RETENCIONES IVSS (monto directo) -->
    <table class="op-table-ret" id="tabla-ret">
        <thead>
            <tr>
                ...
                <th style="width:12%; text-align:right; padding-right:8px;">MONTO RETENCI&Oacute;N</th>
    ...
    <div class="op-ret-totals">
        <div><button type="button" class="btn-add no-print" onclick="addRetRow()">+ Agregar</button></div>
        <div class="op-ret-totals-right">
            <div class="op-ret-tot-row">
                <span>TOTAL RETENCIONES Bs.</span>
                <div class="val-box"><span id="total-retenciones"><?php echo htmlspecialchars($op_edit ? number_format($op_edit['monto_retencion'], 2, '.', ',') : '0.00'); ?></span></div>
            </div>
            <div class="op-ret-tot-row">
                <span>MONTO NETO A PAGAR Bs.</span>
                <div class="val-box-bold"><span id="monto-neto"><?php echo htmlspecialchars($op_edit ? number_format($op_edit['monto_neto_pagar'], 2, '.', ',') : '0.00'); ?></span></div>
            </div>
        </div>
    </div>
    ...
    <table class="op-table-cont" id="tabla-cont">
        <thead>
            <tr>
                <th>A&Ntilde;O</th><th>$ECTOR</th><th>PROG.</th><th>SUB-PROG.</th>
                <th>PROY.</th><th>ACTI.</th><th>OBRA</th><th>PARTID.</th>
                <th>GEN</th><th>ESPEC.</th><th>SUB ESP.</th>
                <th style="width:24%;padding:4px 6px;">
                    <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;">
                        ...
                        <div class="op-cont-total-box"><span id="cont-total-header"><?php echo htmlspecialchars($op_edit ? number_format($op_edit['monto_bruto'], 2, '.', ',') : '0.00'); ?></span></div>
                    </div>
                </th>
                <th style="width:30px" class="no-print"></th>
            </tr>
    ...
    <div class="op-unified-bottom-grid">
        ...
        <div class="op-grid-row op-row-pagado-data">
            <div style="font-weight:800; font-size:10.5px;">Nro. De COMPROBANTE</div>
            <div>
            ...
            <div>
                <input type="text" name="comprobante_cuenta" id="comprobante_cuenta" value="0102-0509-31-0000072355">
            </div>
            <div>
                <input type="text" name="comprobante_transf" value="<?php echo htmlspecialchars($op_edit ? $op_edit['recibe_firma'] : 'ND'); ?>">
            </div>
        </div>
    </div>
...
<input type="hidden" name="doc_tipo"          value="IVSS">
...
</div><?php require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/includes/footer.php'; ?><script>
...
function buildConcepto(){
    ...
    var cta=document.getElementById('arr-cuenta-ivss').value.trim();
    var txt='TRANSFERENCIA PARA LA CUENTA N\u00b0 '+cta+' (FONDOS DE TERCEROS) PARA CANCELAR LAS RETENCIONES Y APORTES PATRONALES DE I.V.S.S. Y PARO FORZOSO CORRESPONDIENTE AL MES DE '+mes+' '+anio+', AL PERSONAL; OBREROS, EMPLEADOS, CONTRALORA, DIRECTORES Y JEFES DE LA CONTRALOR\u00cdA MUNICIPAL SIM\u00d3N RODR\u00cdGUEZ.'+(memo?' SEG\u00daN CONSTA EN MEMORANDUM N\u00b0 '+memo+' DE FECHA '+fecha+'.':'');
    var el=document.getElementById('concepto');
    if(el){el.value=txt;autoExpand(el);}
}

function syncCuenta(val){
    // Mirror the cuenta CTE value into the helper field and comprobante
    var helper=document.getElementById('arr-cuenta-ivss');
...
/* ── IVSS predefined retenciones ─────────────────────────────────────── */
var IVSS_RETS=[
    {desc:'SEGURO SOCIAL EMPLEADOS',    cod:'4.01.01.01.00'},
    {desc:'PARO FORZOSO EMPLEADOS',      cod:'4.01.01.01.00'},
    {desc:'SEGURO SOCIAL OBREROS',        cod:'4.01.01.10.00'},
    {desc:'PARO FORZOSO OBREROS',        cod:'4.01.01.10.00'},
    {desc:'SEGURO SOCIAL CONTRALORA',    cod:'4.01.01.35.00'},
    {desc:'PARO FORZOSO CONTRALORA',      cod:'4.01.01.35.00'},
    {desc:'SEGURO SOCIAL DIRECTORES',    cod:'4.01.01.36.00'},
    {desc:'PARO FORZOSO DIRECTORES',      cod:'4.01.01.36.00'}
];
...
function addRetRow(desc,codigo,monto){
    ...
    var opts=IVSS_RETS.map(function(r){return '<option value="'+r.desc+'">';}).join('');
    var tr=document.createElement('tr');tr.id='ret'+i;
    tr.innerHTML=
        '<td style="position:relative;">'+
            '<input list="ivss-list-'+i+'" type="text" name="ret_desc[]" class="ret-desc" value="'+d+'" placeholder="Descripci\u00f3n" style="text-transform:uppercase;" oninput="this.value=this.value.toUpperCase()">'+
            '<datalist id="ivss-list-'+i+'">'+opts+'</datalist>'+
        '</td>'+
    ...
    descInp.addEventListener('change',function(){
        ...
        for(var k=0;k<IVSS_RETS.length;k++){
            if(IVSS_RETS[k].desc===v){ codInp.value=IVSS_RETS[k].cod; break; }
        }
    });
    recalcRetenciones();
}
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    <?php else: ?>
        // Default rows for new OP
        addRetRow('SEGURO SOCIAL EMPLEADOS','4.01.01.01.00','');
        addRetRow('PARO FORZOSO EMPLEADOS','4.01.01.01.00','');
        addRetRow('SEGURO SOCIAL OBREROS','4.01.01.10.00','');
        addRetRow('PARO FORZOSO OBREROS','4.01.01.10.00','');
        addRetRow('SEGURO SOCIAL CONTRALORA','4.01.01.35.00','');
        addRetRow('PARO FORZOSO CONTRALORA','4.01.01.35.00','');
        addRetRow('SEGURO SOCIAL DIRECTORES','4.01.01.36.00','');
        addRetRow('PARO FORZOSO DIRECTORES','4.01.01.36.00','');
        
        addContRowFromData('2026','01','08','00','00','51','401','06','01','','',0);
        addContRowFromData('2026','01','08','00','00','51','401','06','04','','',0);
        addContRowFromData('2026','01','08','00','00','51','401','06','10','','',0);
        addContRowFromData('2026','01','08','00','00','51','401','06','12','','',0);
        addContRowFromData('2026','01','08','00','00','51','401','06','31','','',0);
        addContRowFromData('2026','01','08','00','00','51','401','06','35','','',0);
        addContRowFromData('2026','01','08','00','00','51','401','06','39','','',0);
        addContRowFromData('2026','01','08','00','00','51','401','06','43','','',0);
...
(function() {
    ...
    document.addEventListener('click', function(e) {
        if (activePopup && !activePopup.contains(e.target) && !e.target.closest('#fecha_op_display, #arr-memo-fecha')) {
            closePopup();
        }
    });
